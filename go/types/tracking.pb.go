...
const (
	...
	SUBJECT_OPEN_METER_READING       Subject = 11
)
...
const (
	...
	INTENT_SUBMIT_OPEN_METER_READING  Intent = 15
)
...
var Intent_name = map[int32]string{
	...
	15: "INTENT_SUBMIT_OPEN_METER_READING",
}
...
var Intent_value = map[string]int32{
	...
	"INTENT_SUBMIT_OPEN_METER_READING":  15,
}
...
var fileDescriptor_62a1d65b4bf956e8 = []byte{
	...
	,
}
